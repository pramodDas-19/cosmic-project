...
const getUserNotifications = async (req, res) => {
  try {
    ...
    // Exclude test/demo notifications by default using $nor
    filter.$nor = [
      { title: { $regex: /test|demo|Test Notification|Self Test/i } },
      { message: { $regex: /test notification|demo notification|verify the system|created by the user for themselves|This is a test notification/i } }
    ];
